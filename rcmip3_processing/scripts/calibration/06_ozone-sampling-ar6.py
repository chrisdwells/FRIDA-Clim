...
# for RCMIP3, don't need the NOx units error correction
...
skeie_trop = pd.read_csv(
    "../../../calibration/data/external/forcing/skeie_ozone_trop.csv", index_col=0
)
...
skeie_strat = pd.read_csv(
    "../../../calibration/data/external/forcing/skeie_ozone_strat.csv", index_col=0
)
...
eesc_file = '../../../calibration/data/external/inputs_for_frida/EESC.csv'
