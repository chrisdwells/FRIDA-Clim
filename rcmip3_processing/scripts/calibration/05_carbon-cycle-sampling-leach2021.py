...
f = FAIR(ch4_method="Thornhill2021", ghg_method='leach2021')
...
df = pd.read_csv(
    "../../../calibration/data/external/4xCO2_cummins_ebm3_cmip6.csv"
)
models_runs = {
...
cc_sample_df.to_csv(
    f"../../data/external/samples_for_priors/carbon_cycle_{samples}.csv",
    index=False,
)
