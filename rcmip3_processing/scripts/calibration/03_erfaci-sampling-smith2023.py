...
for model in models:
    ...
    for run in models_runs[model]:
        file = f"../../../calibration/data/external/smith2023aerosol/{model}_{run}_aerosol_forcing.csv"
...
df_ar6 = pd.read_csv(
    "../../../calibration/data/external/forcing/table_A3.3_historical_ERF_1750-2019_best_estimate.csv"
)
...
df_params.to_csv(
    "../../../calibration/data/external/forcing/aerosol_cloud.csv"
)
