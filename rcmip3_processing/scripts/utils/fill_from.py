...
def fill_from_rcmip(self, emissions_file=None, concentration_file=None, forcing_file=None):
    ...
    species_to_rcmip["CO2 FFI"] = "CO2|Energy and Industrial Processes"
    ...
    for scenario in self.scenarios:
        for specie, specie_rcmip_name in species_to_rcmip.items():
            ...
            if self.properties_df.loc[specie, "input_mode"] == "concentration":
                ...
                conc[self.timebounds < 1750] = np.nan
