...
#NOTE this has been superceded in a newer submission; before we thought the
#protocol wanted jsut the data after (implied) emissions cease, but in fact
#it wants the full data. So we don't split it up anymore but we run it all
#in 1 go in esm-1pct-brch_combined
